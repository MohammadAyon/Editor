...
drop policy if exists "Authenticated can update brand images" on public.brand_images;
drop policy if exists "Authenticated can delete brand images" on public.brand_images;

create policy "Authenticated can read presets" on public.presets for select using (owner_id = auth.uid());
create policy "Authenticated can create presets" on public.presets for insert with check (owner_id = auth.uid());
create policy "Authenticated can update presets" on public.presets for update using (owner_id = auth.uid()) with check (owner_id = auth.uid());
create policy "Authenticated can delete presets" on public.presets for delete using (owner_id = auth.uid());

create policy "Authenticated can read projects" on public.projects for select using (owner_id = auth.uid());
create policy "Authenticated can create projects" on public.projects for insert with check (owner_id = auth.uid());
create policy "Authenticated can update projects" on public.projects for update using (owner_id = auth.uid()) with check (owner_id = auth.uid());
create policy "Authenticated can delete projects" on public.projects for delete using (owner_id = auth.uid());

create policy "Authenticated can read brand images" on public.brand_images for select using (owner_id = auth.uid());
create policy "Authenticated can create brand images" on public.brand_images for insert with check (owner_id = auth.uid());
create policy "Authenticated can update brand images" on public.brand_images for update using (owner_id = auth.uid()) with check (owner_id = auth.uid());
create policy "Authenticated can delete brand images" on public.brand_images for delete using (owner_id = auth.uid());
...
drop policy if exists "Authenticated can update cover images" on storage.objects;
...
create policy "Authenticated can update cover images"
