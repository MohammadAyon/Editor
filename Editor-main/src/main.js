...
import {
  saveToStorage, loadFromStorage, LS_KEYS,
  toCacheSafeBrandImages, toCacheSafeProjects
...
export function switchTab(tab){
  ...
  saveToStorage(LS_KEYS.activeTab, tab);
}
...
export function finishDataInit(){
  ...
  renderCreatePreview();
  render();
  switchTab(loadFromStorage(LS_KEYS.activeTab) || 'create');
}
