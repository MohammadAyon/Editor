...
export function addElement(type){
  ...
  if(type === 'circle') el = { id: newId('el'), type: 'circle', x: 20, y: 20, width: 50, height: 50, fill: '#ffffff', stroke: '#171614', keepRatio: true };
  if(type === 'icon') el = { id: newId('el'), type: 'icon', icon: 'pin', color: '#171614', strokeWidth: 2, filled: false, keepRatio: true, x: 20, y: 20, width: 20, height: 20 };
  if(el){
