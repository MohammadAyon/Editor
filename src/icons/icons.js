...
export const ICONS = [
  ...
  },
  {
    ...
    label: 'Leaf',
    category: 'architecture',
    path: 'M20.84 3.16C12.78 3.16 5.5 6.39 3.16 14.45c-.77 2.66-.77 4.98-.77 6.39 1.41 0 3.73 0 6.39-.77C16.84 17.73 20.84 10.22 20.84 3.16z M3.16 20.84c3.13-3.13 6.4-5.38 10.5-7.5'
  },
  {
    id: 'droplet',
    label: 'Droplet',
  ...
  },
  {
    ...
    label: 'Gear / Settings',
    category: 'architecture',
    path: 'M12 15.25a3.25 3.25 0 1 0 0-6.5 3.25 3.25 0 0 0 0 6.5z M17.68 14.5a1.65 1.65 0 0 0 .33 1.82l.06.06-1.94 1.94-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V19.5h-2.74v-.06a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06-1.94-1.94.06-.06A1.65 1.65 0 0 0 6.08 14.5a1.65 1.65 0 0 0-1.51-1H4.5v-2.74h.07a1.65 1.65 0 0 0 1.51-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06 1.94-1.94.06.06a1.65 1.65 0 0 0 1.82.33 1.65 1.65 0 0 0 1-1.51V4.5h2.74v.32a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06 1.94 1.94-.06.06a1.65 1.65 0 0 0-.33 1.82 1.65 1.65 0 0 0 1.51 1h.32V13.5h-.32a1.65 1.65 0 0 0-1.51 1z'
  },
  {
    id: 'leaf-outline',
    label: 'Leaf Outline',
    category: 'nature',
    path: 'M20 3C10.5 3 4 7.5 4 15c0 3.31 1.69 5 5 5 7.5 0 11-6.5 11-17z M4 20c3.5-3.5 7-5.5 11-7.5'
  },
  {
    id: 'tree-pine',
    label: 'Pine Tree',
    category: 'nature',
    path: 'M12 3L5 12h4l-5 6h6v3h4v-3h6l-5-6h4L12 3z M12 21v-4'
  },
  {
    id: 'flower',
    label: 'Flower',
    category: 'nature',
    path: 'M12 12c-3-2-5-4-5-6a3 3 0 0 1 5-2 3 3 0 0 1 5 2c0 2-2 4-5 6z M12 12c2-3 4-5 6-5a3 3 0 0 1 2 5 3 3 0 0 1-2 5c-2 0-4-2-6-5z M12 12c3 2 5 4 5 6a3 3 0 0 1-5 2 3 3 0 0 1-5-2c0-2 2-4 5-6z M12 12c-2 3-4 5-6 5a3 3 0 0 1-2-5 3 3 0 0 1 2-5c2 0 4 2 6 5z M12 12h.01'
  },
  {
    id: 'hard-hat',
    label: 'Hard Hat',
    category: 'construction',
    path: 'M3 18h18 M5 18v-3a7 7 0 0 1 14 0v3 M8 15V9a4 4 0 0 1 8 0v6 M12 5v4'
  },
  {
    id: 'hammer',
    label: 'Hammer',
    category: 'construction',
    path: 'M14 6l4-4 4 4-4 4 M18 2l-8 8 M11 9l4 4-8 8a2.83 2.83 0 0 1-4-4l8-8z'
  },
  {
    id: 'wrench',
    label: 'Wrench',
    category: 'construction',
    path: 'M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18a2.12 2.12 0 0 0 3 3l6.3-6.3a4 4 0 0 0 5.4-5.4L15 11l-3-3 2.7-1.7z'
  },
  {
    id: 'blueprint',
    label: 'Blueprint',
    category: 'architecture',
    path: 'M4 3h16v18H4z M8 7h8 M8 11h3 M14 11h2 M8 15h8 M8 18h4'
  },
  {
    id: 'pipe',
    label: 'Pipe / Plumbing',
    category: 'construction',
    path: 'M5 3v10a4 4 0 0 0 4 4h10 M5 3h4 M3 3h6 M19 14v6 M16 17h6'
  },
  {
    id: 'family',
    label: 'Family',
